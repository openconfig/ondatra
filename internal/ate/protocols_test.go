		...
		wantNetwTopo: &ixconfig.TopologyNetworkTopology{
			...
			SimRouter: []*ixconfig.TopologySimRouter{{
				...
				IsisL3PseudoRouter: []*ixconfig.TopologyIsisL3PseudoRouter{{
					...
					Mask:                        ixconfig.MultivalueUintList(1),
					IPv4PseudoNodeRoutes: []*ixconfig.TopologyIPv4PseudoNodeRoutes{{
						Active:                 ixconfig.MultivalueBoolList(false),
						NetworkAddress:         ixconfig.MultivalueStrList("0.0.0.0"),
						PrefixLength:           ixconfig.MultivalueUintList(1),
						RangeSize:              ixconfig.MultivalueUintList(1),
						Ipv4Metric:             ixconfig.MultivalueUintList(0),
						Algorithm:              ixconfig.MultivalueUintList(0),
						Ipv4RouteOrigin:        ixconfig.MultivalueStrList("internal"),
		...
		wantNetwTopo: &ixconfig.TopologyNetworkTopology{
			...
			SimRouter: []*ixconfig.TopologySimRouter{{
				...
				IsisL3PseudoRouter: []*ixconfig.TopologyIsisL3PseudoRouter{{
					...
					IPv4PseudoNodeRoutes: []*ixconfig.TopologyIPv4PseudoNodeRoutes{{
						Active:                 ixconfig.MultivalueBoolList(false, false),
						NetworkAddress:         ixconfig.MultivalueStrList("0.0.0.0", "0.0.0.0"),
						PrefixLength:           ixconfig.MultivalueUintList(1, 1),
						RangeSize:              ixconfig.MultivalueUintList(1, 1),
						Ipv4Metric:             ixconfig.MultivalueUintList(0, 0),
						Algorithm:              ixconfig.MultivalueUintList(0, 0),
						Ipv4RouteOrigin:        ixconfig.MultivalueStrList("internal", "internal"),
						ConfigureSIDIndexLabel: ixconfig.MultivalueBoolList(false, false),
						SIDIndexLabel:          ixconfig.MultivalueUintList(0, 0),
						Ipv4RFlag:              ixconfig.MultivalueBoolList(false, false),
						Ipv4NFlag:              ixconfig.MultivalueBoolList(false, false),
						Ipv4PFlag:              ixconfig.MultivalueBoolList(false, false),
						Ipv4EFlag:              ixconfig.MultivalueBoolList(false, false),
						Ipv4VFlag:              ixconfig.MultivalueBoolList(false, false),
						Ipv4LFlag:              ixconfig.MultivalueBoolList(false, false),
					}},
				}},
			}},
		},
