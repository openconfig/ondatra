...
var file_testbed_proto_rawDesc = []byte{
	...
	0x03, 0x5a, 0x50, 0x45, 0x10, 0x08, 0x22, 0xa7, 0x01, 0x0a, 0x04, 0x50, 0x6f, 0x72, 0x74, 0x12,
	...
	0x63, 0x61, 0x72, 0x64, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0x45, 0x0a, 0x05, 0x53, 0x70, 0x65,
	0x65, 0x64, 0x12, 0x15, 0x0a, 0x11, 0x53, 0x50, 0x45, 0x45, 0x44, 0x5f, 0x55, 0x4e, 0x53, 0x50,
	0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x5f, 0x31,
	0x30, 0x47, 0x42, 0x10, 0x0a, 0x12, 0x0b, 0x0a, 0x07, 0x53, 0x5f, 0x31, 0x30, 0x30, 0x47, 0x42,
...
var file_testbed_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_testbed_proto_goTypes = []interface{}{
	...
	(*Testbed)(nil),    // 2: ondatra.Testbed
	(*Device)(nil),     // 3: ondatra.Device
	(*Port)(nil),       // 4: ondatra.Port
	(*Link)(nil),       // 5: ondatra.Link
	nil,                // 6: ondatra.Device.ExtraDimensionsEntry
}
var file_testbed_proto_depIdxs = []int32{
	3, // 0: ondatra.Testbed.duts:type_name -> ondatra.Device
	3, // 1: ondatra.Testbed.ates:type_name -> ondatra.Device
	5, // 2: ondatra.Testbed.links:type_name -> ondatra.Link
	0, // 3: ondatra.Device.vendor:type_name -> ondatra.Device.Vendor
	4, // 4: ondatra.Device.ports:type_name -> ondatra.Port
	6, // 5: ondatra.Device.extra_dimensions:type_name -> ondatra.Device.ExtraDimensionsEntry
