...
var ΛEnum = map[string]map[int64]ygot.EnumDefinition{
	...
	"E_FsTypes_OPENCONFIG_FS_MOUNT": {
		1:  {Name: "CGROUP_FS", DefiningModule: "openconfig-fs-types"},
		2:  {Name: "DEBUGFS_FS", DefiningModule: "openconfig-fs-types"},
		3:  {Name: "DEVPTS_FS", DefiningModule: "openconfig-fs-types"},
		4:  {Name: "DEVTMPFS_FS", DefiningModule: "openconfig-fs-types"},
		5:  {Name: "EXT4_FS", DefiningModule: "openconfig-fs-types"},
		6:  {Name: "OVERLAY_FS", DefiningModule: "openconfig-fs-types"},
		7:  {Name: "PROC_FS", DefiningModule: "openconfig-fs-types"},
		8:  {Name: "RAMFS_FS", DefiningModule: "openconfig-fs-types"},
		9:  {Name: "SYSFS_FS", DefiningModule: "openconfig-fs-types"},
		10: {Name: "TMPFS_FS", DefiningModule: "openconfig-fs-types"},
		11: {Name: "UNKNOWN", DefiningModule: "openconfig-fs-types"},
		12: {Name: "VFAT_FS", DefiningModule: "openconfig-fs-types"},
	},
	...
	"E_KeychainTypes_CRYPTO_TYPE": {
		1:  {Name: "AES_128_CBC", DefiningModule: "openconfig-keychain-types"},
		2:  {Name: "AES_128_CMAC", DefiningModule: "openconfig-keychain-types"},
		3:  {Name: "AES_128_CMAC_96", DefiningModule: "openconfig-keychain-types"},
		4:  {Name: "AES_128_GCM_128", DefiningModule: "openconfig-keychain-types"},
		5:  {Name: "AES_128_GCM_64", DefiningModule: "openconfig-keychain-types"},
		6:  {Name: "AES_192_CBC", DefiningModule: "openconfig-keychain-types"},
		7:  {Name: "AES_256_CBC", DefiningModule: "openconfig-keychain-types"},
		8:  {Name: "AES_256_CMAC", DefiningModule: "openconfig-keychain-types"},
		9:  {Name: "AES_256_GCM_128", DefiningModule: "openconfig-keychain-types"},
		10: {Name: "CRYPTO_NONE", DefiningModule: "openconfig-keychain-types"},
		11: {Name: "HMAC_MD5", DefiningModule: "openconfig-keychain-types"},
		12: {Name: "HMAC_SHA_1", DefiningModule: "openconfig-keychain-types"},
		13: {Name: "HMAC_SHA_1_12", DefiningModule: "openconfig-keychain-types"},
		14: {Name: "HMAC_SHA_1_20", DefiningModule: "openconfig-keychain-types"},
		15: {Name: "HMAC_SHA_1_96", DefiningModule: "openconfig-keychain-types"},
		16: {Name: "HMAC_SHA_256", DefiningModule: "openconfig-keychain-types"},
		17: {Name: "HMAC_SHA_384", DefiningModule: "openconfig-keychain-types"},
		18: {Name: "HMAC_SHA_512", DefiningModule: "openconfig-keychain-types"},
		19: {Name: "MD5", DefiningModule: "openconfig-keychain-types"},
		20: {Name: "SHA_1", DefiningModule: "openconfig-keychain-types"},
		21: {Name: "TRIPLE_DES", DefiningModule: "openconfig-keychain-types"},
	},
	...
	"E_Lldp_MgmtInterfaceNumberSubtype": {
		2: {Name: "UNKNOWN"},
		3: {Name: "IFINDEX"},
		4: {Name: "SYSTEM_PORT_NUMBER"},
	},
	"E_Lldp_PortIdType": {
	...
	"E_LocalRouting_LOCAL_DEFINED_WEIGHT": {
		1: {Name: "AUTO", DefiningModule: "openconfig-local-routing"},
	},
	...
	"E_SystemGrpc_GRPC_SERVICE": {
		...
		2: {Name: "GNPSI", DefiningModule: "openconfig-gnpsi-types"},
		3: {Name: "GNSI", DefiningModule: "openconfig-gnsi"},
		4: {Name: "GRIBI", DefiningModule: "openconfig-gribi"},
		5: {Name: "P4RT", DefiningModule: "openconfig-p4rt"},
	},
	...
	"E_TransportTypes_ETHERNET_PMD_TYPE": {
		...
		35: {Name: "ETH_800GBASE_ZR", DefiningModule: "openconfig-transport-types"},
		36: {Name: "ETH_UNDEFINED", DefiningModule: "openconfig-transport-types"},
	},
	...
	"E_TransportTypes_TRIBUTARY_PROTOCOL_TYPE": {
		...
		8:  {Name: "PROT_800GE", DefiningModule: "openconfig-transport-types"},
		9:  {Name: "PROT_FLEXO", DefiningModule: "openconfig-transport-types"},
		10: {Name: "PROT_OC192", DefiningModule: "openconfig-transport-types"},
		11: {Name: "PROT_OC48", DefiningModule: "openconfig-transport-types"},
		12: {Name: "PROT_OC768", DefiningModule: "openconfig-transport-types"},
		13: {Name: "PROT_ODU2", DefiningModule: "openconfig-transport-types"},
		14: {Name: "PROT_ODU2E", DefiningModule: "openconfig-transport-types"},
		15: {Name: "PROT_ODU3", DefiningModule: "openconfig-transport-types"},
		16: {Name: "PROT_ODU4", DefiningModule: "openconfig-transport-types"},
		17: {Name: "PROT_ODUCN", DefiningModule: "openconfig-transport-types"},
	...
	"E_TransportTypes_TRIBUTARY_RATE_CLASS_TYPE": {
		...
		17: {Name: "TRIB_RATE_1650G", DefiningModule: "openconfig-transport-types"},
		18: {Name: "TRIB_RATE_1700G", DefiningModule: "openconfig-transport-types"},
		19: {Name: "TRIB_RATE_1750G", DefiningModule: "openconfig-transport-types"},
		20: {Name: "TRIB_RATE_1800G", DefiningModule: "openconfig-transport-types"},
		21: {Name: "TRIB_RATE_1850G", DefiningModule: "openconfig-transport-types"},
		22: {Name: "TRIB_RATE_1900G", DefiningModule: "openconfig-transport-types"},
		23: {Name: "TRIB_RATE_1950G", DefiningModule: "openconfig-transport-types"},
		24: {Name: "TRIB_RATE_1G", DefiningModule: "openconfig-transport-types"},
		25: {Name: "TRIB_RATE_2.5G", DefiningModule: "openconfig-transport-types"},
		26: {Name: "TRIB_RATE_2000G", DefiningModule: "openconfig-transport-types"},
		27: {Name: "TRIB_RATE_200G", DefiningModule: "openconfig-transport-types"},
		28: {Name: "TRIB_RATE_2050G", DefiningModule: "openconfig-transport-types"},
		29: {Name: "TRIB_RATE_2100G", DefiningModule: "openconfig-transport-types"},
		30: {Name: "TRIB_RATE_2150G", DefiningModule: "openconfig-transport-types"},
		31: {Name: "TRIB_RATE_2200G", DefiningModule: "openconfig-transport-types"},
		32: {Name: "TRIB_RATE_2250G", DefiningModule: "openconfig-transport-types"},
		33: {Name: "TRIB_RATE_2300G", DefiningModule: "openconfig-transport-types"},
		34: {Name: "TRIB_RATE_2350G", DefiningModule: "openconfig-transport-types"},
		35: {Name: "TRIB_RATE_2400G", DefiningModule: "openconfig-transport-types"},
		36: {Name: "TRIB_RATE_2450G", DefiningModule: "openconfig-transport-types"},
		37: {Name: "TRIB_RATE_2500G", DefiningModule: "openconfig-transport-types"},
		38: {Name: "TRIB_RATE_250G", DefiningModule: "openconfig-transport-types"},
		39: {Name: "TRIB_RATE_2550G", DefiningModule: "openconfig-transport-types"},
		40: {Name: "TRIB_RATE_2600G", DefiningModule: "openconfig-transport-types"},
		41: {Name: "TRIB_RATE_2650G", DefiningModule: "openconfig-transport-types"},
		42: {Name: "TRIB_RATE_2700G", DefiningModule: "openconfig-transport-types"},
		43: {Name: "TRIB_RATE_2750G", DefiningModule: "openconfig-transport-types"},
		44: {Name: "TRIB_RATE_2800G", DefiningModule: "openconfig-transport-types"},
		45: {Name: "TRIB_RATE_2850G", DefiningModule: "openconfig-transport-types"},
		46: {Name: "TRIB_RATE_2900G", DefiningModule: "openconfig-transport-types"},
		47: {Name: "TRIB_RATE_2950G", DefiningModule: "openconfig-transport-types"},
		48: {Name: "TRIB_RATE_3000G", DefiningModule: "openconfig-transport-types"},
		49: {Name: "TRIB_RATE_300G", DefiningModule: "openconfig-transport-types"},
		50: {Name: "TRIB_RATE_3050G", DefiningModule: "openconfig-transport-types"},
		51: {Name: "TRIB_RATE_3100G", DefiningModule: "openconfig-transport-types"},
		52: {Name: "TRIB_RATE_3150G", DefiningModule: "openconfig-transport-types"},
		53: {Name: "TRIB_RATE_3200G", DefiningModule: "openconfig-transport-types"},
		54: {Name: "TRIB_RATE_350G", DefiningModule: "openconfig-transport-types"},
		55: {Name: "TRIB_RATE_400G", DefiningModule: "openconfig-transport-types"},
		56: {Name: "TRIB_RATE_40G", DefiningModule: "openconfig-transport-types"},
		57: {Name: "TRIB_RATE_450G", DefiningModule: "openconfig-transport-types"},
		58: {Name: "TRIB_RATE_500G", DefiningModule: "openconfig-transport-types"},
		59: {Name: "TRIB_RATE_550G", DefiningModule: "openconfig-transport-types"},
		60: {Name: "TRIB_RATE_600G", DefiningModule: "openconfig-transport-types"},
		61: {Name: "TRIB_RATE_650G", DefiningModule: "openconfig-transport-types"},
		62: {Name: "TRIB_RATE_700G", DefiningModule: "openconfig-transport-types"},
		63: {Name: "TRIB_RATE_750G", DefiningModule: "openconfig-transport-types"},
		64: {Name: "TRIB_RATE_800G", DefiningModule: "openconfig-transport-types"},
		65: {Name: "TRIB_RATE_850G", DefiningModule: "openconfig-transport-types"},
		66: {Name: "TRIB_RATE_900G", DefiningModule: "openconfig-transport-types"},
		67: {Name: "TRIB_RATE_950G", DefiningModule: "openconfig-transport-types"},
	},
...
func initΛEnumTypes() {
	ΛEnumTypes = map[string][]reflect.Type{
		...
		"/acl/acl-sets/acl-set/acl-entries/acl-entry/ipv4/config/fragment-offsets": {
			reflect.TypeOf((E_Ipv4_FragmentOffsets)(0)),
		},
		...
		"/acl/acl-sets/acl-set/acl-entries/acl-entry/ipv4/state/fragment-offsets": {
			reflect.TypeOf((E_Ipv4_FragmentOffsets)(0)),
		},
		...
		"/acl/acl-sets/acl-set/acl-entries/acl-entry/ipv6/icmpv6/config/code": {
			reflect.TypeOf((E_Icmpv6Types_CODE)(0)),
		},
		"/acl/acl-sets/acl-set/acl-entries/acl-entry/ipv6/icmpv6/config/type": {
		...
		"/acl/acl-sets/acl-set/acl-entries/acl-entry/mpls/config/end-label-value": {
			reflect.TypeOf((E_Mpls_EndLabelValue)(0)),
		},
		"/acl/acl-sets/acl-set/acl-entries/acl-entry/mpls/config/start-label-value": {
		...
		"/acl/interfaces/interface/egress-acl-sets/egress-acl-set/config/type": {
			reflect.TypeOf((E_Acl_ACL_TYPE)(0)),
		},
		...
		"/components/component/transceiver/config/module-functional-type": {
		...
		"/defined-sets/port-sets/port-set/config/exclude-port": {
			reflect.TypeOf((E_PortSet_ExcludePort)(0)),
		},
		"/defined-sets/port-sets/port-set/config/port": {
			reflect.TypeOf((E_PortSet_Port)(0)),
		},
		"/defined-sets/port-sets/port-set/state/exclude-port": {
			reflect.TypeOf((E_PortSet_ExcludePort)(0)),
		},
		...
		"/lldp/interfaces/interface/neighbors/neighbor/mgmt-addresses/mgmt-address/state/interface-number-subtype": {
			reflect.TypeOf((E_Lldp_MgmtInterfaceNumberSubtype)(0)),
		},
		...
		"/lldp/mgmt-addresses/mgmt-address/state/interface-number-subtype": {
			reflect.TypeOf((E_Lldp_MgmtInterfaceNumberSubtype)(0)),
		},
		...
		"/network-instances/network-instance/evpn/evpn-instances/evpn-instance/config/encapsulation-type": {
			reflect.TypeOf((E_NetworkInstanceTypes_ENCAPSULATION)(0)),
		},
		"/network-instances/network-instance/evpn/evpn-instances/evpn-instance/config/replication-mode": {
			reflect.TypeOf((E_EvpnInstance_ReplicationMode)(0)),
		},
		"/network-instances/network-instance/evpn/evpn-instances/evpn-instance/config/route-distinguisher": {
			reflect.TypeOf((E_EvpnInstance_RouteDistinguisher)(0)),
		},
		"/network-instances/network-instance/evpn/evpn-instances/evpn-instance/config/service-type": {
			reflect.TypeOf((E_EvpnTypes_EVPN_TYPE)(0)),
		},
		"/network-instances/network-instance/evpn/evpn-instances/evpn-instance/import-export-policy/config/export-route-target": {
			reflect.TypeOf((E_ImportExportPolicy_ExportRouteTarget)(0)),
		},
		"/network-instances/network-instance/evpn/evpn-instances/evpn-instance/import-export-policy/config/import-route-target": {
		...
		"/network-instances/network-instance/fdb/l2rib/mac-ip-table/next-hop-groups/next-hop-group/state/type": {
		...
		"/network-instances/network-instance/fdb/l2rib/mac-table/next-hop-groups/next-hop-group/state/type": {
			reflect.TypeOf((E_NextHopGroup_Type)(0)),
		},
		...
		"/network-instances/network-instance/mpls/global/config/pw-encapsulation": {
		...
		"/network-instances/network-instance/mpls/lsps/constrained-path/tunnels/tunnel/p2p-tunnel-attributes/p2p-primary-path/p2p-primary-path/config/path-control": {
			reflect.TypeOf((E_Mpls_LspControlType)(0)),
		},
		"/network-instances/network-instance/mpls/lsps/constrained-path/tunnels/tunnel/p2p-tunnel-attributes/p2p-primary-path/p2p-primary-path/path-metric-bound-constraints/path-metric-bound-constraint/config/type": {
		...
		"/network-instances/network-instance/mpls/lsps/constrained-path/tunnels/tunnel/p2p-tunnel-attributes/p2p-secondary-paths/p2p-secondary-path/config/path-control": {
			reflect.TypeOf((E_Mpls_LspControlType)(0)),
		},
		"/network-instances/network-instance/mpls/lsps/constrained-path/tunnels/tunnel/p2p-tunnel-attributes/p2p-secondary-paths/p2p-secondary-path/path-metric-bound-constraints/path-metric-bound-constraint/config/type": {
			reflect.TypeOf((E_MplsTypes_PATH_METRIC_TYPE)(0)),
		},
		...
		"/network-instances/network-instance/mpls/signaling-protocols/ldp/interface-attributes/interfaces/interface/address-families/address-family/config/afi-name": {
		...
		"/network-instances/network-instance/mpls/signaling-protocols/ldp/targeted/address-families/address-family/config/afi-name": {
			reflect.TypeOf((E_MplsLdp_MplsLdpAfi)(0)),
		},
		"/network-instances/network-instance/mpls/signaling-protocols/ldp/targeted/address-families/address-family/state/afi-name": {
			reflect.TypeOf((E_MplsLdp_MplsLdpAfi)(0)),
		},
		"/network-instances/network-instance/mpls/signaling-protocols/rsvp-te/interface-attributes/interface/authentication/config/authentication-type": {
		...
		"/network-instances/network-instance/policy-forwarding/policies/policy/rules/rule/ipv4/config/fragment-offsets": {
			reflect.TypeOf((E_Ipv4_FragmentOffsets)(0)),
		},
		...
		"/network-instances/network-instance/policy-forwarding/policies/policy/rules/rule/ipv4/state/fragment-offsets": {
			reflect.TypeOf((E_Ipv4_FragmentOffsets)(0)),
		},
		...
		"/network-instances/network-instance/protocols/protocol/isis/global/segment-routing/flex-algorithm-bindings/flex-algorithm-binding/config/isis-level": {
		...
		"/network-instances/network-instance/protocols/protocol/local-aggregates/aggregate/config/wecmp-weight": {
			reflect.TypeOf((E_LocalRouting_LOCAL_DEFINED_WEIGHT)(0)),
		},
		"/network-instances/network-instance/protocols/protocol/local-aggregates/aggregate/state/wecmp-weight": {
			reflect.TypeOf((E_LocalRouting_LOCAL_DEFINED_WEIGHT)(0)),
		},
		...
		"/network-instances/network-instance/protocols/protocol/pim/interfaces/interface/config/mode": {
		...
		"/network-instances/network-instance/protocols/protocol/static-routes/static/next-hops/next-hop/config/wecmp-weight": {
			reflect.TypeOf((E_LocalRouting_LOCAL_DEFINED_WEIGHT)(0)),
		},
		"/network-instances/network-instance/protocols/protocol/static-routes/static/next-hops/next-hop/state/next-hop": {
			reflect.TypeOf((E_LocalRouting_LOCAL_DEFINED_NEXT_HOP)(0)),
		},
		"/network-instances/network-instance/protocols/protocol/static-routes/static/next-hops/next-hop/state/wecmp-weight": {
			reflect.TypeOf((E_LocalRouting_LOCAL_DEFINED_WEIGHT)(0)),
		},
		"/network-instances/network-instance/route-limits/route-limit/config/afi": {
			reflect.TypeOf((E_Types_ADDRESS_FAMILY)(0)),
		},
		...
		"/network-instances/network-instance/static/next-hops/next-hop/config/wecmp-weight": {
			reflect.TypeOf((E_LocalRouting_LOCAL_DEFINED_WEIGHT)(0)),
		},
		...
		"/network-instances/network-instance/static/next-hops/next-hop/encap-headers/encap-header/mpls/config/label": {
			reflect.TypeOf((E_Mpls_Label)(0)),
		},
		"/network-instances/network-instance/static/next-hops/next-hop/encap-headers/encap-header/mpls/state/label": {
			reflect.TypeOf((E_Mpls_Label)(0)),
		},
		...
		"/network-instances/network-instance/static/next-hops/next-hop/state/wecmp-weight": {
			reflect.TypeOf((E_LocalRouting_LOCAL_DEFINED_WEIGHT)(0)),
		},
		...
		"/qos/classifiers/classifier/terms/term/conditions/ipv4/config/fragment-offsets": {
			reflect.TypeOf((E_Ipv4_FragmentOffsets)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/ipv4/config/protocol": {
			reflect.TypeOf((E_PacketMatchTypes_IP_PROTOCOL)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/ipv4/icmpv4/config/code": {
			reflect.TypeOf((E_Icmpv4Types_CODE)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/ipv4/icmpv4/config/type": {
			reflect.TypeOf((E_Icmpv4Types_TYPE)(0)),
		},
		...
		"/qos/classifiers/classifier/terms/term/conditions/ipv4/state/fragment-offsets": {
			reflect.TypeOf((E_Ipv4_FragmentOffsets)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/ipv4/state/protocol": {
			reflect.TypeOf((E_PacketMatchTypes_IP_PROTOCOL)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/ipv6/config/protocol": {
			reflect.TypeOf((E_PacketMatchTypes_IP_PROTOCOL)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/ipv6/icmpv6/config/code": {
			reflect.TypeOf((E_Icmpv6Types_CODE)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/ipv6/icmpv6/config/type": {
			reflect.TypeOf((E_Icmpv6Types_TYPE)(0)),
		},
		...
		"/qos/classifiers/classifier/terms/term/conditions/transport/config/builtin-detail": {
			reflect.TypeOf((E_Transport_BuiltinDetail)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/transport/config/destination-port": {
			reflect.TypeOf((E_Transport_DestinationPort)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/transport/config/detail-mode": {
			reflect.TypeOf((E_Transport_DetailMode)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/transport/config/explicit-detail-match-mode": {
			reflect.TypeOf((E_Transport_ExplicitDetailMatchMode)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/transport/config/explicit-tcp-flags": {
			reflect.TypeOf((E_PacketMatchTypes_TCP_FLAGS)(0)),
		},
		"/qos/classifiers/classifier/terms/term/conditions/transport/config/source-port": {
			reflect.TypeOf((E_Transport_SourcePort)(0)),
		},
		...
		"/qos/interfaces/interface/output/classifiers/classifier/config/type": {
			reflect.TypeOf((E_Input_Classifier_Type)(0)),
		},
		...
		"/qos/scheduler-policies/scheduler-policy/schedulers/scheduler/output/config/output-type": {
		...
		"/routing-policy/policy-definitions/policy-definition/statements/statement/actions/bgp-actions/set-ext-community/config/method": {
			reflect.TypeOf((E_SetCommunity_Method)(0)),
		},
		...
		"/routing-policy/policy-definitions/policy-definition/statements/statement/actions/bgp-actions/set-ext-community/inline/config/communities": {
			reflect.TypeOf((E_BgpTypes_BGP_WELL_KNOWN_STD_COMMUNITY)(0)),
		},
		...
		"/routing-policy/policy-definitions/policy-definition/statements/statement/actions/set-tag/config/mode": {
		...
		"/routing-policy/policy-definitions/policy-definition/statements/statement/conditions/bgp-conditions/as-path-length/config/operator": {
		...
		"/routing-policy/policy-definitions/policy-definition/statements/statement/conditions/bgp-conditions/config/afi-safi-in": {
			reflect.TypeOf((E_BgpTypes_AFI_SAFI_TYPE)(0)),
		},
		...
		"/system/grpc-servers/grpc-server/config/services": {
		...
		"/system/mount-points/mount-point/state/type": {
			reflect.TypeOf((E_FsTypes_OPENCONFIG_FS_MOUNT)(0)),
		},
		...
		"/terminal-device/logical-channels/channel/config/client-mapping-mode": {
		...
		"/terminal-device/logical-channels/channel/ethernet/config/client-als": {
