...
// E_FsTypes_OPENCONFIG_FS_MOUNT is a derived int64 type which is used to represent
// the enumerated node FsTypes_OPENCONFIG_FS_MOUNT. An additional value named
// FsTypes_OPENCONFIG_FS_MOUNT_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_FsTypes_OPENCONFIG_FS_MOUNT int64

// IsYANGGoEnum ensures that FsTypes_OPENCONFIG_FS_MOUNT implements the yang.GoEnum
// interface. This ensures that FsTypes_OPENCONFIG_FS_MOUNT can be identified as a
// mapped type for a YANG enumeration.
func (E_FsTypes_OPENCONFIG_FS_MOUNT) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  FsTypes_OPENCONFIG_FS_MOUNT.
func (E_FsTypes_OPENCONFIG_FS_MOUNT) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_FsTypes_OPENCONFIG_FS_MOUNT.
func (e E_FsTypes_OPENCONFIG_FS_MOUNT) String() string {
	return ygot.EnumLogString(e, int64(e), "E_FsTypes_OPENCONFIG_FS_MOUNT")
}

const (
	// FsTypes_OPENCONFIG_FS_MOUNT_UNSET corresponds to the value UNSET of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_UNSET E_FsTypes_OPENCONFIG_FS_MOUNT = 0
	// FsTypes_OPENCONFIG_FS_MOUNT_CGROUP_FS corresponds to the value CGROUP_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_CGROUP_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 1
	// FsTypes_OPENCONFIG_FS_MOUNT_DEBUGFS_FS corresponds to the value DEBUGFS_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_DEBUGFS_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 2
	// FsTypes_OPENCONFIG_FS_MOUNT_DEVPTS_FS corresponds to the value DEVPTS_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_DEVPTS_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 3
	// FsTypes_OPENCONFIG_FS_MOUNT_DEVTMPFS_FS corresponds to the value DEVTMPFS_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_DEVTMPFS_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 4
	// FsTypes_OPENCONFIG_FS_MOUNT_EXT4_FS corresponds to the value EXT4_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_EXT4_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 5
	// FsTypes_OPENCONFIG_FS_MOUNT_OVERLAY_FS corresponds to the value OVERLAY_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_OVERLAY_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 6
	// FsTypes_OPENCONFIG_FS_MOUNT_PROC_FS corresponds to the value PROC_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_PROC_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 7
	// FsTypes_OPENCONFIG_FS_MOUNT_RAMFS_FS corresponds to the value RAMFS_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_RAMFS_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 8
	// FsTypes_OPENCONFIG_FS_MOUNT_SYSFS_FS corresponds to the value SYSFS_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_SYSFS_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 9
	// FsTypes_OPENCONFIG_FS_MOUNT_TMPFS_FS corresponds to the value TMPFS_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_TMPFS_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 10
	// FsTypes_OPENCONFIG_FS_MOUNT_UNKNOWN corresponds to the value UNKNOWN of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_UNKNOWN E_FsTypes_OPENCONFIG_FS_MOUNT = 11
	// FsTypes_OPENCONFIG_FS_MOUNT_VFAT_FS corresponds to the value VFAT_FS of FsTypes_OPENCONFIG_FS_MOUNT
	FsTypes_OPENCONFIG_FS_MOUNT_VFAT_FS E_FsTypes_OPENCONFIG_FS_MOUNT = 12
)
...
// E_Ipv4_FragmentOffsets is a derived int64 type which is used to represent
// the enumerated node Ipv4_FragmentOffsets. An additional value named
// Ipv4_FragmentOffsets_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Ipv4_FragmentOffsets int64

// IsYANGGoEnum ensures that Ipv4_FragmentOffsets implements the yang.GoEnum
// interface. This ensures that Ipv4_FragmentOffsets can be identified as a
// mapped type for a YANG enumeration.
func (E_Ipv4_FragmentOffsets) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Ipv4_FragmentOffsets.
func (E_Ipv4_FragmentOffsets) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Ipv4_FragmentOffsets.
func (e E_Ipv4_FragmentOffsets) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Ipv4_FragmentOffsets")
}

const (
	// Ipv4_FragmentOffsets_UNSET corresponds to the value UNSET of Ipv4_FragmentOffsets
	Ipv4_FragmentOffsets_UNSET E_Ipv4_FragmentOffsets = 0
	// Ipv4_FragmentOffsets_ANY corresponds to the value ANY of Ipv4_FragmentOffsets
	Ipv4_FragmentOffsets_ANY E_Ipv4_FragmentOffsets = 1
)
...
// E_LocalRouting_LOCAL_DEFINED_WEIGHT is a derived int64 type which is used to represent
// the enumerated node LocalRouting_LOCAL_DEFINED_WEIGHT. An additional value named
// LocalRouting_LOCAL_DEFINED_WEIGHT_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_LocalRouting_LOCAL_DEFINED_WEIGHT int64

// IsYANGGoEnum ensures that LocalRouting_LOCAL_DEFINED_WEIGHT implements the yang.GoEnum
// interface. This ensures that LocalRouting_LOCAL_DEFINED_WEIGHT can be identified as a
// mapped type for a YANG enumeration.
func (E_LocalRouting_LOCAL_DEFINED_WEIGHT) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  LocalRouting_LOCAL_DEFINED_WEIGHT.
func (E_LocalRouting_LOCAL_DEFINED_WEIGHT) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_LocalRouting_LOCAL_DEFINED_WEIGHT.
func (e E_LocalRouting_LOCAL_DEFINED_WEIGHT) String() string {
	return ygot.EnumLogString(e, int64(e), "E_LocalRouting_LOCAL_DEFINED_WEIGHT")
}

const (
	// LocalRouting_LOCAL_DEFINED_WEIGHT_UNSET corresponds to the value UNSET of LocalRouting_LOCAL_DEFINED_WEIGHT
	LocalRouting_LOCAL_DEFINED_WEIGHT_UNSET E_LocalRouting_LOCAL_DEFINED_WEIGHT = 0
	// LocalRouting_LOCAL_DEFINED_WEIGHT_AUTO corresponds to the value AUTO of LocalRouting_LOCAL_DEFINED_WEIGHT
	LocalRouting_LOCAL_DEFINED_WEIGHT_AUTO E_LocalRouting_LOCAL_DEFINED_WEIGHT = 1
)
...
// E_Mpls_Label is a derived int64 type which is used to represent
// the enumerated node Mpls_Label. An additional value named
// Mpls_Label_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Mpls_Label int64

// IsYANGGoEnum ensures that Mpls_Label implements the yang.GoEnum
// interface. This ensures that Mpls_Label can be identified as a
// mapped type for a YANG enumeration.
func (E_Mpls_Label) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Mpls_Label.
func (E_Mpls_Label) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Mpls_Label.
func (e E_Mpls_Label) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Mpls_Label")
}

const (
	// Mpls_Label_UNSET corresponds to the value UNSET of Mpls_Label
	Mpls_Label_UNSET E_Mpls_Label = 0
	// Mpls_Label_IPV4_EXPLICIT_NULL corresponds to the value IPV4_EXPLICIT_NULL of Mpls_Label
	Mpls_Label_IPV4_EXPLICIT_NULL E_Mpls_Label = 1
	// Mpls_Label_ROUTER_ALERT corresponds to the value ROUTER_ALERT of Mpls_Label
	Mpls_Label_ROUTER_ALERT E_Mpls_Label = 2
	// Mpls_Label_IPV6_EXPLICIT_NULL corresponds to the value IPV6_EXPLICIT_NULL of Mpls_Label
	Mpls_Label_IPV6_EXPLICIT_NULL E_Mpls_Label = 3
	// Mpls_Label_IMPLICIT_NULL corresponds to the value IMPLICIT_NULL of Mpls_Label
	Mpls_Label_IMPLICIT_NULL E_Mpls_Label = 4
	// Mpls_Label_ENTROPY_LABEL_INDICATOR corresponds to the value ENTROPY_LABEL_INDICATOR of Mpls_Label
	Mpls_Label_ENTROPY_LABEL_INDICATOR E_Mpls_Label = 8
	// Mpls_Label_NO_LABEL corresponds to the value NO_LABEL of Mpls_Label
	Mpls_Label_NO_LABEL E_Mpls_Label = 9
)
...
const (
	...
	// Mpls_MplsHopType_EXCLUDE corresponds to the value EXCLUDE of Mpls_MplsHopType
	Mpls_MplsHopType_EXCLUDE E_Mpls_MplsHopType = 3
)
...
const (
	...
	// PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_FPGA corresponds to the value FPGA of PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_FPGA E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 9
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_FRU E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 10
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_INTEGRATED_CIRCUIT E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 11
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_LINECARD E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 12
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_OPTICAL_CHANNEL E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 13
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_PORT E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 14
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_POWER_SUPPLY E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 15
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_SENSOR E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 16
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_STORAGE E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 17
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_TRANSCEIVER E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 18
	// PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_USB_PORT corresponds to the value USB_PORT of PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_USB_PORT E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 19
	...
	PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT_WIFI_ACCESS_POINT E_PlatformTypes_OPENCONFIG_HARDWARE_COMPONENT = 20
)
...
// E_PortSet_ExcludePort is a derived int64 type which is used to represent
// the enumerated node PortSet_ExcludePort. An additional value named
// PortSet_ExcludePort_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_PortSet_ExcludePort int64

// IsYANGGoEnum ensures that PortSet_ExcludePort implements the yang.GoEnum
// interface. This ensures that PortSet_ExcludePort can be identified as a
// mapped type for a YANG enumeration.
func (E_PortSet_ExcludePort) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  PortSet_ExcludePort.
func (E_PortSet_ExcludePort) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_PortSet_ExcludePort.
func (e E_PortSet_ExcludePort) String() string {
	return ygot.EnumLogString(e, int64(e), "E_PortSet_ExcludePort")
}

const (
	// PortSet_ExcludePort_UNSET corresponds to the value UNSET of PortSet_ExcludePort
	PortSet_ExcludePort_UNSET E_PortSet_ExcludePort = 0
	// PortSet_ExcludePort_ANY corresponds to the value ANY of PortSet_ExcludePort
	PortSet_ExcludePort_ANY E_PortSet_ExcludePort = 1
)
...
const (
	...
	// SystemGrpc_GRPC_SERVICE_GNPSI corresponds to the value GNPSI of SystemGrpc_GRPC_SERVICE
	SystemGrpc_GRPC_SERVICE_GNPSI E_SystemGrpc_GRPC_SERVICE = 2
	// SystemGrpc_GRPC_SERVICE_GNSI corresponds to the value GNSI of SystemGrpc_GRPC_SERVICE
	SystemGrpc_GRPC_SERVICE_GNSI E_SystemGrpc_GRPC_SERVICE = 3
	// SystemGrpc_GRPC_SERVICE_GRIBI corresponds to the value GRIBI of SystemGrpc_GRPC_SERVICE
	SystemGrpc_GRPC_SERVICE_GRIBI E_SystemGrpc_GRPC_SERVICE = 4
	// SystemGrpc_GRPC_SERVICE_P4RT corresponds to the value P4RT of SystemGrpc_GRPC_SERVICE
	SystemGrpc_GRPC_SERVICE_P4RT E_SystemGrpc_GRPC_SERVICE = 5
)
...
const (
	...
	// TransportTypes_ETHERNET_PMD_TYPE_ETH_800GBASE_ZR corresponds to the value ETH_800GBASE_ZR of TransportTypes_ETHERNET_PMD_TYPE
	TransportTypes_ETHERNET_PMD_TYPE_ETH_800GBASE_ZR E_TransportTypes_ETHERNET_PMD_TYPE = 35
	...
	TransportTypes_ETHERNET_PMD_TYPE_ETH_UNDEFINED E_TransportTypes_ETHERNET_PMD_TYPE = 36
)
