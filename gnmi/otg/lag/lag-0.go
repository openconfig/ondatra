...
func (n *Lag_InRatePath) State() ygnmi.SingletonQuery[oc.Binary] {
...
//	Path from parent:     "state/in-rate"
//	Path from root:       "/lags/lag/state/in-rate"
func (n *Lag_InRatePathAny) State() ygnmi.WildcardQuery[oc.Binary] {
...
func (n *Lag_OutRatePath) State() ygnmi.SingletonQuery[oc.Binary] {
	return ygnmi.NewLeafSingletonQuery[oc.Binary](
		"Lag",
		true,
		false,
...
//	Path from parent:     "state/out-rate"
//	Path from root:       "/lags/lag/state/out-rate"
func (n *Lag_OutRatePathAny) State() ygnmi.WildcardQuery[oc.Binary] {
	return ygnmi.NewLeafWildcardQuery[oc.Binary](
		"Lag",
		true,
		false,
