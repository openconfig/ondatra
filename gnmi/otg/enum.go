...
// E_Bgp_UnicastIpv4Prefix_Origin is a derived int64 type which is used to represent
// the enumerated node Bgp_UnicastIpv4Prefix_Origin. An additional value named
// Bgp_UnicastIpv4Prefix_Origin_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Bgp_UnicastIpv4Prefix_Origin int64

// IsYANGGoEnum ensures that Bgp_UnicastIpv4Prefix_Origin implements the yang.GoEnum
// interface. This ensures that Bgp_UnicastIpv4Prefix_Origin can be identified as a
// mapped type for a YANG enumeration.
func (E_Bgp_UnicastIpv4Prefix_Origin) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Bgp_UnicastIpv4Prefix_Origin.
func (E_Bgp_UnicastIpv4Prefix_Origin) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Bgp_UnicastIpv4Prefix_Origin.
func (e E_Bgp_UnicastIpv4Prefix_Origin) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Bgp_UnicastIpv4Prefix_Origin")
}

const (
	// Bgp_UnicastIpv4Prefix_Origin_UNSET corresponds to the value UNSET of Bgp_UnicastIpv4Prefix_Origin
	Bgp_UnicastIpv4Prefix_Origin_UNSET E_Bgp_UnicastIpv4Prefix_Origin = 0
	// Bgp_UnicastIpv4Prefix_Origin_IGP corresponds to the value IGP of Bgp_UnicastIpv4Prefix_Origin
	Bgp_UnicastIpv4Prefix_Origin_IGP E_Bgp_UnicastIpv4Prefix_Origin = 1
	// Bgp_UnicastIpv4Prefix_Origin_EGP corresponds to the value EGP of Bgp_UnicastIpv4Prefix_Origin
	Bgp_UnicastIpv4Prefix_Origin_EGP E_Bgp_UnicastIpv4Prefix_Origin = 2
	// Bgp_UnicastIpv4Prefix_Origin_INCOMPLETE corresponds to the value INCOMPLETE of Bgp_UnicastIpv4Prefix_Origin
	Bgp_UnicastIpv4Prefix_Origin_INCOMPLETE E_Bgp_UnicastIpv4Prefix_Origin = 3
)

// E_Bgp_UnicastIpv6Prefix_Origin is a derived int64 type which is used to represent
// the enumerated node Bgp_UnicastIpv6Prefix_Origin. An additional value named
// Bgp_UnicastIpv6Prefix_Origin_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Bgp_UnicastIpv6Prefix_Origin int64

// IsYANGGoEnum ensures that Bgp_UnicastIpv6Prefix_Origin implements the yang.GoEnum
// interface. This ensures that Bgp_UnicastIpv6Prefix_Origin can be identified as a
// mapped type for a YANG enumeration.
func (E_Bgp_UnicastIpv6Prefix_Origin) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Bgp_UnicastIpv6Prefix_Origin.
func (E_Bgp_UnicastIpv6Prefix_Origin) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Bgp_UnicastIpv6Prefix_Origin.
func (e E_Bgp_UnicastIpv6Prefix_Origin) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Bgp_UnicastIpv6Prefix_Origin")
}

const (
	// Bgp_UnicastIpv6Prefix_Origin_UNSET corresponds to the value UNSET of Bgp_UnicastIpv6Prefix_Origin
	Bgp_UnicastIpv6Prefix_Origin_UNSET E_Bgp_UnicastIpv6Prefix_Origin = 0
	// Bgp_UnicastIpv6Prefix_Origin_IGP corresponds to the value IGP of Bgp_UnicastIpv6Prefix_Origin
	Bgp_UnicastIpv6Prefix_Origin_IGP E_Bgp_UnicastIpv6Prefix_Origin = 1
	// Bgp_UnicastIpv6Prefix_Origin_EGP corresponds to the value EGP of Bgp_UnicastIpv6Prefix_Origin
	Bgp_UnicastIpv6Prefix_Origin_EGP E_Bgp_UnicastIpv6Prefix_Origin = 2
	// Bgp_UnicastIpv6Prefix_Origin_INCOMPLETE corresponds to the value INCOMPLETE of Bgp_UnicastIpv6Prefix_Origin
	Bgp_UnicastIpv6Prefix_Origin_INCOMPLETE E_Bgp_UnicastIpv6Prefix_Origin = 3
)
...
// E_BmpServer_UnicastIpv4Prefix_Origin is a derived int64 type which is used to represent
// the enumerated node BmpServer_UnicastIpv4Prefix_Origin. An additional value named
// BmpServer_UnicastIpv4Prefix_Origin_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BmpServer_UnicastIpv4Prefix_Origin int64

// IsYANGGoEnum ensures that BmpServer_UnicastIpv4Prefix_Origin implements the yang.GoEnum
// interface. This ensures that BmpServer_UnicastIpv4Prefix_Origin can be identified as a
// mapped type for a YANG enumeration.
func (E_BmpServer_UnicastIpv4Prefix_Origin) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BmpServer_UnicastIpv4Prefix_Origin.
func (E_BmpServer_UnicastIpv4Prefix_Origin) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_BmpServer_UnicastIpv4Prefix_Origin.
func (e E_BmpServer_UnicastIpv4Prefix_Origin) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BmpServer_UnicastIpv4Prefix_Origin")
}

const (
	// BmpServer_UnicastIpv4Prefix_Origin_UNSET corresponds to the value UNSET of BmpServer_UnicastIpv4Prefix_Origin
	BmpServer_UnicastIpv4Prefix_Origin_UNSET E_BmpServer_UnicastIpv4Prefix_Origin = 0
	// BmpServer_UnicastIpv4Prefix_Origin_IGP corresponds to the value IGP of BmpServer_UnicastIpv4Prefix_Origin
	BmpServer_UnicastIpv4Prefix_Origin_IGP E_BmpServer_UnicastIpv4Prefix_Origin = 1
	// BmpServer_UnicastIpv4Prefix_Origin_EGP corresponds to the value EGP of BmpServer_UnicastIpv4Prefix_Origin
	BmpServer_UnicastIpv4Prefix_Origin_EGP E_BmpServer_UnicastIpv4Prefix_Origin = 2
	// BmpServer_UnicastIpv4Prefix_Origin_INCOMPLETE corresponds to the value INCOMPLETE of BmpServer_UnicastIpv4Prefix_Origin
	BmpServer_UnicastIpv4Prefix_Origin_INCOMPLETE E_BmpServer_UnicastIpv4Prefix_Origin = 3
)

// E_BmpServer_UnicastIpv6Prefix_Origin is a derived int64 type which is used to represent
// the enumerated node BmpServer_UnicastIpv6Prefix_Origin. An additional value named
// BmpServer_UnicastIpv6Prefix_Origin_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BmpServer_UnicastIpv6Prefix_Origin int64

// IsYANGGoEnum ensures that BmpServer_UnicastIpv6Prefix_Origin implements the yang.GoEnum
// interface. This ensures that BmpServer_UnicastIpv6Prefix_Origin can be identified as a
// mapped type for a YANG enumeration.
func (E_BmpServer_UnicastIpv6Prefix_Origin) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BmpServer_UnicastIpv6Prefix_Origin.
func (E_BmpServer_UnicastIpv6Prefix_Origin) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_BmpServer_UnicastIpv6Prefix_Origin.
func (e E_BmpServer_UnicastIpv6Prefix_Origin) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BmpServer_UnicastIpv6Prefix_Origin")
}

const (
	// BmpServer_UnicastIpv6Prefix_Origin_UNSET corresponds to the value UNSET of BmpServer_UnicastIpv6Prefix_Origin
	BmpServer_UnicastIpv6Prefix_Origin_UNSET E_BmpServer_UnicastIpv6Prefix_Origin = 0
	// BmpServer_UnicastIpv6Prefix_Origin_IGP corresponds to the value IGP of BmpServer_UnicastIpv6Prefix_Origin
	BmpServer_UnicastIpv6Prefix_Origin_IGP E_BmpServer_UnicastIpv6Prefix_Origin = 1
	// BmpServer_UnicastIpv6Prefix_Origin_EGP corresponds to the value EGP of BmpServer_UnicastIpv6Prefix_Origin
	BmpServer_UnicastIpv6Prefix_Origin_EGP E_BmpServer_UnicastIpv6Prefix_Origin = 2
	// BmpServer_UnicastIpv6Prefix_Origin_INCOMPLETE corresponds to the value INCOMPLETE of BmpServer_UnicastIpv6Prefix_Origin
	BmpServer_UnicastIpv6Prefix_Origin_INCOMPLETE E_BmpServer_UnicastIpv6Prefix_Origin = 3
)
...
// E_Peer_SessionIpType is a derived int64 type which is used to represent
// the enumerated node Peer_SessionIpType. An additional value named
// Peer_SessionIpType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Peer_SessionIpType int64

// IsYANGGoEnum ensures that Peer_SessionIpType implements the yang.GoEnum
// interface. This ensures that Peer_SessionIpType can be identified as a
// mapped type for a YANG enumeration.
func (E_Peer_SessionIpType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Peer_SessionIpType.
func (E_Peer_SessionIpType) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Peer_SessionIpType.
func (e E_Peer_SessionIpType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Peer_SessionIpType")
}

const (
	// Peer_SessionIpType_UNSET corresponds to the value UNSET of Peer_SessionIpType
	Peer_SessionIpType_UNSET E_Peer_SessionIpType = 0
	// Peer_SessionIpType_IPv4 corresponds to the value IPv4 of Peer_SessionIpType
...
// the enumerated node Peer_Status. An additional value named
// Peer_Status_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Peer_Status int64

// IsYANGGoEnum ensures that Peer_Status implements the yang.GoEnum
// interface. This ensures that Peer_Status can be identified as a
// mapped type for a YANG enumeration.
func (E_Peer_Status) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Peer_Status.
func (E_Peer_Status) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Peer_Status.
func (e E_Peer_Status) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Peer_Status")
}

const (
	// Peer_Status_UNSET corresponds to the value UNSET of Peer_Status
	Peer_Status_UNSET E_Peer_Status = 0
	// Peer_Status_UP corresponds to the value UP of Peer_Status
	Peer_Status_UP E_Peer_Status = 1
	// Peer_Status_DOWN corresponds to the value DOWN of Peer_Status
	Peer_Status_DOWN E_Peer_Status = 2
)
...
// E_State_Type is a derived int64 type which is used to represent
// the enumerated node State_Type. An additional value named
// State_Type_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_State_Type int64

// IsYANGGoEnum ensures that State_Type implements the yang.GoEnum
// interface. This ensures that State_Type can be identified as a
// mapped type for a YANG enumeration.
func (E_State_Type) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  State_Type.
func (E_State_Type) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_State_Type.
func (e E_State_Type) String() string {
	return ygot.EnumLogString(e, int64(e), "E_State_Type")
}
...
// E_UnicastIpv4Prefix_NextHopType is a derived int64 type which is used to represent
// the enumerated node UnicastIpv4Prefix_NextHopType. An additional value named
// UnicastIpv4Prefix_NextHopType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_UnicastIpv4Prefix_NextHopType int64

// IsYANGGoEnum ensures that UnicastIpv4Prefix_NextHopType implements the yang.GoEnum
// interface. This ensures that UnicastIpv4Prefix_NextHopType can be identified as a
// mapped type for a YANG enumeration.
func (E_UnicastIpv4Prefix_NextHopType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  UnicastIpv4Prefix_NextHopType.
func (E_UnicastIpv4Prefix_NextHopType) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_UnicastIpv4Prefix_NextHopType.
func (e E_UnicastIpv4Prefix_NextHopType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_UnicastIpv4Prefix_NextHopType")
}

const (
	// UnicastIpv4Prefix_NextHopType_UNSET corresponds to the value UNSET of UnicastIpv4Prefix_NextHopType
	UnicastIpv4Prefix_NextHopType_UNSET E_UnicastIpv4Prefix_NextHopType = 0
	// UnicastIpv4Prefix_NextHopType_IPv4 corresponds to the value IPv4 of UnicastIpv4Prefix_NextHopType
	UnicastIpv4Prefix_NextHopType_IPv4 E_UnicastIpv4Prefix_NextHopType = 1
	// UnicastIpv4Prefix_NextHopType_IPv6 corresponds to the value IPv6 of UnicastIpv4Prefix_NextHopType
	UnicastIpv4Prefix_NextHopType_IPv6 E_UnicastIpv4Prefix_NextHopType = 2
)

// E_UnicastIpv4Prefix_RouteState is a derived int64 type which is used to represent
// the enumerated node UnicastIpv4Prefix_RouteState. An additional value named
// UnicastIpv4Prefix_RouteState_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_UnicastIpv4Prefix_RouteState int64

// IsYANGGoEnum ensures that UnicastIpv4Prefix_RouteState implements the yang.GoEnum
// interface. This ensures that UnicastIpv4Prefix_RouteState can be identified as a
// mapped type for a YANG enumeration.
func (E_UnicastIpv4Prefix_RouteState) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  UnicastIpv4Prefix_RouteState.
func (E_UnicastIpv4Prefix_RouteState) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_UnicastIpv4Prefix_RouteState.
func (e E_UnicastIpv4Prefix_RouteState) String() string {
	return ygot.EnumLogString(e, int64(e), "E_UnicastIpv4Prefix_RouteState")
}

const (
	// UnicastIpv4Prefix_RouteState_UNSET corresponds to the value UNSET of UnicastIpv4Prefix_RouteState
	UnicastIpv4Prefix_RouteState_UNSET E_UnicastIpv4Prefix_RouteState = 0
	// UnicastIpv4Prefix_RouteState_ADVERTISED corresponds to the value ADVERTISED of UnicastIpv4Prefix_RouteState
	UnicastIpv4Prefix_RouteState_ADVERTISED E_UnicastIpv4Prefix_RouteState = 1
	// UnicastIpv4Prefix_RouteState_WITHDRAWN corresponds to the value WITHDRAWN of UnicastIpv4Prefix_RouteState
	UnicastIpv4Prefix_RouteState_WITHDRAWN E_UnicastIpv4Prefix_RouteState = 2
)

// E_UnicastIpv6Prefix_NextHopType is a derived int64 type which is used to represent
// the enumerated node UnicastIpv6Prefix_NextHopType. An additional value named
// UnicastIpv6Prefix_NextHopType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_UnicastIpv6Prefix_NextHopType int64

// IsYANGGoEnum ensures that UnicastIpv6Prefix_NextHopType implements the yang.GoEnum
// interface. This ensures that UnicastIpv6Prefix_NextHopType can be identified as a
// mapped type for a YANG enumeration.
func (E_UnicastIpv6Prefix_NextHopType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  UnicastIpv6Prefix_NextHopType.
func (E_UnicastIpv6Prefix_NextHopType) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_UnicastIpv6Prefix_NextHopType.
func (e E_UnicastIpv6Prefix_NextHopType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_UnicastIpv6Prefix_NextHopType")
}

const (
	// UnicastIpv6Prefix_NextHopType_UNSET corresponds to the value UNSET of UnicastIpv6Prefix_NextHopType
	UnicastIpv6Prefix_NextHopType_UNSET E_UnicastIpv6Prefix_NextHopType = 0
	// UnicastIpv6Prefix_NextHopType_IPv4 corresponds to the value IPv4 of UnicastIpv6Prefix_NextHopType
	UnicastIpv6Prefix_NextHopType_IPv4 E_UnicastIpv6Prefix_NextHopType = 1
	// UnicastIpv6Prefix_NextHopType_IPv6 corresponds to the value IPv6 of UnicastIpv6Prefix_NextHopType
	UnicastIpv6Prefix_NextHopType_IPv6 E_UnicastIpv6Prefix_NextHopType = 2
)

// E_UnicastIpv6Prefix_RouteState is a derived int64 type which is used to represent
// the enumerated node UnicastIpv6Prefix_RouteState. An additional value named
// UnicastIpv6Prefix_RouteState_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_UnicastIpv6Prefix_RouteState int64

// IsYANGGoEnum ensures that UnicastIpv6Prefix_RouteState implements the yang.GoEnum
// interface. This ensures that UnicastIpv6Prefix_RouteState can be identified as a
// mapped type for a YANG enumeration.
func (E_UnicastIpv6Prefix_RouteState) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  UnicastIpv6Prefix_RouteState.
func (E_UnicastIpv6Prefix_RouteState) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_UnicastIpv6Prefix_RouteState.
func (e E_UnicastIpv6Prefix_RouteState) String() string {
	return ygot.EnumLogString(e, int64(e), "E_UnicastIpv6Prefix_RouteState")
}

const (
	// UnicastIpv6Prefix_RouteState_UNSET corresponds to the value UNSET of UnicastIpv6Prefix_RouteState
	UnicastIpv6Prefix_RouteState_UNSET E_UnicastIpv6Prefix_RouteState = 0
	// UnicastIpv6Prefix_RouteState_ADVERTISED corresponds to the value ADVERTISED of UnicastIpv6Prefix_RouteState
	UnicastIpv6Prefix_RouteState_ADVERTISED E_UnicastIpv6Prefix_RouteState = 1
	// UnicastIpv6Prefix_RouteState_WITHDRAWN corresponds to the value WITHDRAWN of UnicastIpv6Prefix_RouteState
	UnicastIpv6Prefix_RouteState_WITHDRAWN E_UnicastIpv6Prefix_RouteState = 2
)
