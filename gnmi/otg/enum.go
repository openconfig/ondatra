...
// E_BmpUnicastIpv4Prefix_NextHopType is a derived int64 type which is used to represent
// the enumerated node BmpUnicastIpv4Prefix_NextHopType. An additional value named
// BmpUnicastIpv4Prefix_NextHopType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BmpUnicastIpv4Prefix_NextHopType int64

// IsYANGGoEnum ensures that BmpUnicastIpv4Prefix_NextHopType implements the yang.GoEnum
// interface. This ensures that BmpUnicastIpv4Prefix_NextHopType can be identified as a
// mapped type for a YANG enumeration.
func (E_BmpUnicastIpv4Prefix_NextHopType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BmpUnicastIpv4Prefix_NextHopType.
func (E_BmpUnicastIpv4Prefix_NextHopType) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_BmpUnicastIpv4Prefix_NextHopType.
func (e E_BmpUnicastIpv4Prefix_NextHopType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BmpUnicastIpv4Prefix_NextHopType")
}

const (
	// BmpUnicastIpv4Prefix_NextHopType_UNSET corresponds to the value UNSET of BmpUnicastIpv4Prefix_NextHopType
	BmpUnicastIpv4Prefix_NextHopType_UNSET E_BmpUnicastIpv4Prefix_NextHopType = 0
	// BmpUnicastIpv4Prefix_NextHopType_IPv4 corresponds to the value IPv4 of BmpUnicastIpv4Prefix_NextHopType
	BmpUnicastIpv4Prefix_NextHopType_IPv4 E_BmpUnicastIpv4Prefix_NextHopType = 1
	// BmpUnicastIpv4Prefix_NextHopType_IPv6 corresponds to the value IPv6 of BmpUnicastIpv4Prefix_NextHopType
	BmpUnicastIpv4Prefix_NextHopType_IPv6 E_BmpUnicastIpv4Prefix_NextHopType = 2
)

// E_BmpUnicastIpv4Prefix_Origin is a derived int64 type which is used to represent
// the enumerated node BmpUnicastIpv4Prefix_Origin. An additional value named
// BmpUnicastIpv4Prefix_Origin_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BmpUnicastIpv4Prefix_Origin int64

// IsYANGGoEnum ensures that BmpUnicastIpv4Prefix_Origin implements the yang.GoEnum
// interface. This ensures that BmpUnicastIpv4Prefix_Origin can be identified as a
// mapped type for a YANG enumeration.
func (E_BmpUnicastIpv4Prefix_Origin) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BmpUnicastIpv4Prefix_Origin.
func (E_BmpUnicastIpv4Prefix_Origin) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_BmpUnicastIpv4Prefix_Origin.
func (e E_BmpUnicastIpv4Prefix_Origin) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BmpUnicastIpv4Prefix_Origin")
}

const (
	// BmpUnicastIpv4Prefix_Origin_UNSET corresponds to the value UNSET of BmpUnicastIpv4Prefix_Origin
	BmpUnicastIpv4Prefix_Origin_UNSET E_BmpUnicastIpv4Prefix_Origin = 0
	// BmpUnicastIpv4Prefix_Origin_IGP corresponds to the value IGP of BmpUnicastIpv4Prefix_Origin
	BmpUnicastIpv4Prefix_Origin_IGP E_BmpUnicastIpv4Prefix_Origin = 1
	// BmpUnicastIpv4Prefix_Origin_EGP corresponds to the value EGP of BmpUnicastIpv4Prefix_Origin
	BmpUnicastIpv4Prefix_Origin_EGP E_BmpUnicastIpv4Prefix_Origin = 2
	// BmpUnicastIpv4Prefix_Origin_INCOMPLETE corresponds to the value INCOMPLETE of BmpUnicastIpv4Prefix_Origin
	BmpUnicastIpv4Prefix_Origin_INCOMPLETE E_BmpUnicastIpv4Prefix_Origin = 3
)

// E_BmpUnicastIpv4Prefix_RouteState is a derived int64 type which is used to represent
// the enumerated node BmpUnicastIpv4Prefix_RouteState. An additional value named
// BmpUnicastIpv4Prefix_RouteState_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BmpUnicastIpv4Prefix_RouteState int64

// IsYANGGoEnum ensures that BmpUnicastIpv4Prefix_RouteState implements the yang.GoEnum
// interface. This ensures that BmpUnicastIpv4Prefix_RouteState can be identified as a
// mapped type for a YANG enumeration.
func (E_BmpUnicastIpv4Prefix_RouteState) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BmpUnicastIpv4Prefix_RouteState.
func (E_BmpUnicastIpv4Prefix_RouteState) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_BmpUnicastIpv4Prefix_RouteState.
func (e E_BmpUnicastIpv4Prefix_RouteState) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BmpUnicastIpv4Prefix_RouteState")
}

const (
	// BmpUnicastIpv4Prefix_RouteState_UNSET corresponds to the value UNSET of BmpUnicastIpv4Prefix_RouteState
	BmpUnicastIpv4Prefix_RouteState_UNSET E_BmpUnicastIpv4Prefix_RouteState = 0
	// BmpUnicastIpv4Prefix_RouteState_ADVERTISED corresponds to the value ADVERTISED of BmpUnicastIpv4Prefix_RouteState
	BmpUnicastIpv4Prefix_RouteState_ADVERTISED E_BmpUnicastIpv4Prefix_RouteState = 1
	// BmpUnicastIpv4Prefix_RouteState_WITHDRAWN corresponds to the value WITHDRAWN of BmpUnicastIpv4Prefix_RouteState
	BmpUnicastIpv4Prefix_RouteState_WITHDRAWN E_BmpUnicastIpv4Prefix_RouteState = 2
)

// E_BmpUnicastIpv6Prefix_NextHopType is a derived int64 type which is used to represent
// the enumerated node BmpUnicastIpv6Prefix_NextHopType. An additional value named
// BmpUnicastIpv6Prefix_NextHopType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BmpUnicastIpv6Prefix_NextHopType int64

// IsYANGGoEnum ensures that BmpUnicastIpv6Prefix_NextHopType implements the yang.GoEnum
// interface. This ensures that BmpUnicastIpv6Prefix_NextHopType can be identified as a
// mapped type for a YANG enumeration.
func (E_BmpUnicastIpv6Prefix_NextHopType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BmpUnicastIpv6Prefix_NextHopType.
func (E_BmpUnicastIpv6Prefix_NextHopType) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_BmpUnicastIpv6Prefix_NextHopType.
func (e E_BmpUnicastIpv6Prefix_NextHopType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BmpUnicastIpv6Prefix_NextHopType")
}

const (
	// BmpUnicastIpv6Prefix_NextHopType_UNSET corresponds to the value UNSET of BmpUnicastIpv6Prefix_NextHopType
	BmpUnicastIpv6Prefix_NextHopType_UNSET E_BmpUnicastIpv6Prefix_NextHopType = 0
	// BmpUnicastIpv6Prefix_NextHopType_IPv4 corresponds to the value IPv4 of BmpUnicastIpv6Prefix_NextHopType
	BmpUnicastIpv6Prefix_NextHopType_IPv4 E_BmpUnicastIpv6Prefix_NextHopType = 1
	// BmpUnicastIpv6Prefix_NextHopType_IPv6 corresponds to the value IPv6 of BmpUnicastIpv6Prefix_NextHopType
	BmpUnicastIpv6Prefix_NextHopType_IPv6 E_BmpUnicastIpv6Prefix_NextHopType = 2
)

// E_BmpUnicastIpv6Prefix_Origin is a derived int64 type which is used to represent
// the enumerated node BmpUnicastIpv6Prefix_Origin. An additional value named
// BmpUnicastIpv6Prefix_Origin_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BmpUnicastIpv6Prefix_Origin int64

// IsYANGGoEnum ensures that BmpUnicastIpv6Prefix_Origin implements the yang.GoEnum
// interface. This ensures that BmpUnicastIpv6Prefix_Origin can be identified as a
// mapped type for a YANG enumeration.
func (E_BmpUnicastIpv6Prefix_Origin) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BmpUnicastIpv6Prefix_Origin.
func (E_BmpUnicastIpv6Prefix_Origin) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_BmpUnicastIpv6Prefix_Origin.
func (e E_BmpUnicastIpv6Prefix_Origin) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BmpUnicastIpv6Prefix_Origin")
}

const (
	// BmpUnicastIpv6Prefix_Origin_UNSET corresponds to the value UNSET of BmpUnicastIpv6Prefix_Origin
	BmpUnicastIpv6Prefix_Origin_UNSET E_BmpUnicastIpv6Prefix_Origin = 0
	// BmpUnicastIpv6Prefix_Origin_IGP corresponds to the value IGP of BmpUnicastIpv6Prefix_Origin
	BmpUnicastIpv6Prefix_Origin_IGP E_BmpUnicastIpv6Prefix_Origin = 1
	// BmpUnicastIpv6Prefix_Origin_EGP corresponds to the value EGP of BmpUnicastIpv6Prefix_Origin
	BmpUnicastIpv6Prefix_Origin_EGP E_BmpUnicastIpv6Prefix_Origin = 2
	// BmpUnicastIpv6Prefix_Origin_INCOMPLETE corresponds to the value INCOMPLETE of BmpUnicastIpv6Prefix_Origin
	BmpUnicastIpv6Prefix_Origin_INCOMPLETE E_BmpUnicastIpv6Prefix_Origin = 3
)

// E_BmpUnicastIpv6Prefix_RouteState is a derived int64 type which is used to represent
// the enumerated node BmpUnicastIpv6Prefix_RouteState. An additional value named
// BmpUnicastIpv6Prefix_RouteState_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_BmpUnicastIpv6Prefix_RouteState int64

// IsYANGGoEnum ensures that BmpUnicastIpv6Prefix_RouteState implements the yang.GoEnum
// interface. This ensures that BmpUnicastIpv6Prefix_RouteState can be identified as a
// mapped type for a YANG enumeration.
func (E_BmpUnicastIpv6Prefix_RouteState) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  BmpUnicastIpv6Prefix_RouteState.
func (E_BmpUnicastIpv6Prefix_RouteState) ΛMap() map[string]map[int64]ygot.EnumDefinition {
	return ΛEnum
}

// String returns a logging-friendly string for E_BmpUnicastIpv6Prefix_RouteState.
func (e E_BmpUnicastIpv6Prefix_RouteState) String() string {
	return ygot.EnumLogString(e, int64(e), "E_BmpUnicastIpv6Prefix_RouteState")
}

const (
	// BmpUnicastIpv6Prefix_RouteState_UNSET corresponds to the value UNSET of BmpUnicastIpv6Prefix_RouteState
	BmpUnicastIpv6Prefix_RouteState_UNSET E_BmpUnicastIpv6Prefix_RouteState = 0
	// BmpUnicastIpv6Prefix_RouteState_ADVERTISED corresponds to the value ADVERTISED of BmpUnicastIpv6Prefix_RouteState
	BmpUnicastIpv6Prefix_RouteState_ADVERTISED E_BmpUnicastIpv6Prefix_RouteState = 1
	// BmpUnicastIpv6Prefix_RouteState_WITHDRAWN corresponds to the value WITHDRAWN of BmpUnicastIpv6Prefix_RouteState
	BmpUnicastIpv6Prefix_RouteState_WITHDRAWN E_BmpUnicastIpv6Prefix_RouteState = 2
)
...
// E_Ipv4MplsUnicastPrefix_Origin is a derived int64 type which is used to represent
// the enumerated node Ipv4MplsUnicastPrefix_Origin. An additional value named
// Ipv4MplsUnicastPrefix_Origin_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Ipv4MplsUnicastPrefix_Origin int64

// IsYANGGoEnum ensures that Ipv4MplsUnicastPrefix_Origin implements the yang.GoEnum
// interface. This ensures that Ipv4MplsUnicastPrefix_Origin can be identified as a
// mapped type for a YANG enumeration.
func (E_Ipv4MplsUnicastPrefix_Origin) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Ipv4MplsUnicastPrefix_Origin.
func (E_Ipv4MplsUnicastPrefix_Origin) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Ipv4MplsUnicastPrefix_Origin.
func (e E_Ipv4MplsUnicastPrefix_Origin) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Ipv4MplsUnicastPrefix_Origin")
}

const (
	// Ipv4MplsUnicastPrefix_Origin_UNSET corresponds to the value UNSET of Ipv4MplsUnicastPrefix_Origin
	Ipv4MplsUnicastPrefix_Origin_UNSET E_Ipv4MplsUnicastPrefix_Origin = 0
	// Ipv4MplsUnicastPrefix_Origin_IGP corresponds to the value IGP of Ipv4MplsUnicastPrefix_Origin
	Ipv4MplsUnicastPrefix_Origin_IGP E_Ipv4MplsUnicastPrefix_Origin = 1
	// Ipv4MplsUnicastPrefix_Origin_EGP corresponds to the value EGP of Ipv4MplsUnicastPrefix_Origin
	Ipv4MplsUnicastPrefix_Origin_EGP E_Ipv4MplsUnicastPrefix_Origin = 2
	// Ipv4MplsUnicastPrefix_Origin_INCOMPLETE corresponds to the value INCOMPLETE of Ipv4MplsUnicastPrefix_Origin
	Ipv4MplsUnicastPrefix_Origin_INCOMPLETE E_Ipv4MplsUnicastPrefix_Origin = 3
)

// E_Ipv6MplsUnicastPrefix_Origin is a derived int64 type which is used to represent
// the enumerated node Ipv6MplsUnicastPrefix_Origin. An additional value named
// Ipv6MplsUnicastPrefix_Origin_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_Ipv6MplsUnicastPrefix_Origin int64

// IsYANGGoEnum ensures that Ipv6MplsUnicastPrefix_Origin implements the yang.GoEnum
// interface. This ensures that Ipv6MplsUnicastPrefix_Origin can be identified as a
// mapped type for a YANG enumeration.
func (E_Ipv6MplsUnicastPrefix_Origin) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  Ipv6MplsUnicastPrefix_Origin.
func (E_Ipv6MplsUnicastPrefix_Origin) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }

// String returns a logging-friendly string for E_Ipv6MplsUnicastPrefix_Origin.
func (e E_Ipv6MplsUnicastPrefix_Origin) String() string {
	return ygot.EnumLogString(e, int64(e), "E_Ipv6MplsUnicastPrefix_Origin")
}

const (
	// Ipv6MplsUnicastPrefix_Origin_UNSET corresponds to the value UNSET of Ipv6MplsUnicastPrefix_Origin
	Ipv6MplsUnicastPrefix_Origin_UNSET E_Ipv6MplsUnicastPrefix_Origin = 0
	// Ipv6MplsUnicastPrefix_Origin_IGP corresponds to the value IGP of Ipv6MplsUnicastPrefix_Origin
	Ipv6MplsUnicastPrefix_Origin_IGP E_Ipv6MplsUnicastPrefix_Origin = 1
	// Ipv6MplsUnicastPrefix_Origin_EGP corresponds to the value EGP of Ipv6MplsUnicastPrefix_Origin
	Ipv6MplsUnicastPrefix_Origin_EGP E_Ipv6MplsUnicastPrefix_Origin = 2
	// Ipv6MplsUnicastPrefix_Origin_INCOMPLETE corresponds to the value INCOMPLETE of Ipv6MplsUnicastPrefix_Origin
	Ipv6MplsUnicastPrefix_Origin_INCOMPLETE E_Ipv6MplsUnicastPrefix_Origin = 3
)
