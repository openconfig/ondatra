...
func (n *Port_InRatePath) State() ygnmi.SingletonQuery[oc.Binary] {
...
// 	Path from parent:     "state/in-rate"
// 	Path from root:       "/ports/port/state/in-rate"
func (n *Port_InRatePathAny) State() ygnmi.WildcardQuery[oc.Binary] {
...
func (n *Port_OutRatePath) State() ygnmi.SingletonQuery[oc.Binary] {
	return ygnmi.NewLeafSingletonQuery[oc.Binary](
		"Port",
		true,
		false,
...
// 	Path from parent:     "state/out-rate"
// 	Path from root:       "/ports/port/state/out-rate"
func (n *Port_OutRatePathAny) State() ygnmi.WildcardQuery[oc.Binary] {
	return ygnmi.NewLeafWildcardQuery[oc.Binary](
		"Port",
		true,
		false,
