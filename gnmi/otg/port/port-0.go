...
func (n *Port_LinkPath) State() ygnmi.SingletonQuery[oc.E_Port_Link] {
	return ygnmi.NewSingletonQuery[oc.E_Port_Link](
		"Port",
		true,
		false,
		true,
...
func (n *Port_LinkPathAny) State() ygnmi.WildcardQuery[oc.E_Port_Link] {
	return ygnmi.NewWildcardQuery[oc.E_Port_Link](
		"Port",
		true,
		false,
		true,
...
func (n *PortPath) State() ygnmi.SingletonQuery[*oc.Port] {
	return ygnmi.NewSingletonQuery[*oc.Port](
		"Port",
		true,
		false,
		false,
...
func (n *PortPathAny) State() ygnmi.WildcardQuery[*oc.Port] {
	return ygnmi.NewWildcardQuery[*oc.Port](
		"Port",
		true,
		false,
		false,
...
func (n *Port_CountersPathAny) InFrames() *Port_Counters_InFramesPathAny {
	ps := &Port_Counters_InFramesPathAny{
		NodePath: ygnmi.NewNodePath(
			[]string{"in-frames"},
			map[string]interface{}{},
			n,
...
func (n *Port_CountersPathAny) InOctets() *Port_Counters_InOctetsPathAny {
	ps := &Port_Counters_InOctetsPathAny{
		NodePath: ygnmi.NewNodePath(
			[]string{"in-octets"},
			map[string]interface{}{},
			n,
...
func (n *Port_CountersPath) OutFrames() *Port_Counters_OutFramesPath {
	ps := &Port_Counters_OutFramesPath{
		NodePath: ygnmi.NewNodePath(
			[]string{"out-frames"},
			map[string]interface{}{},
			n,
...
func (n *Port_CountersPathAny) OutFrames() *Port_Counters_OutFramesPathAny {
	ps := &Port_Counters_OutFramesPathAny{
		NodePath: ygnmi.NewNodePath(
			[]string{"out-frames"},
			map[string]interface{}{},
			n,
...
func (n *Port_CountersPath) OutOctets() *Port_Counters_OutOctetsPath {
	ps := &Port_Counters_OutOctetsPath{
		NodePath: ygnmi.NewNodePath(
			[]string{"out-octets"},
			map[string]interface{}{},
			n,
...
func (n *Port_CountersPathAny) OutOctets() *Port_Counters_OutOctetsPathAny {
	ps := &Port_Counters_OutOctetsPathAny{
		NodePath: ygnmi.NewNodePath(
			[]string{"out-octets"},
			map[string]interface{}{},
			n,
...
func (n *Port_CountersPath) State() ygnmi.SingletonQuery[*oc.Port_Counters] {
	return ygnmi.NewSingletonQuery[*oc.Port_Counters](
		"Port_Counters",
		true,
		false,
		false,
