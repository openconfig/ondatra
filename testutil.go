...
var (
	...
	fakeJuniper = &fakebind.DUT{
		AbstractDUT: &binding.AbstractDUT{&binding.Dims{
			...
			Ports: map[string]*binding.Port{
				"port1": &binding.Port{Name: "Et1/2/3", Speed: opb.Port_S_10GB, CardModel: "EX9200-40T", PMD: opb.Port_PMD_100GBASE_FR},
			},
		}},
	}
	fakeIxia = &fakebind.ATE{
		AbstractATE: &binding.AbstractATE{&binding.Dims{
			...
			Ports: map[string]*binding.Port{
				...
				"port2": &binding.Port{Name: "1/2", Speed: opb.Port_S_100GB, CardModel: "NOVUS", PMD: opb.Port_PMD_100GBASE_FR},
			},
		}},
	}
