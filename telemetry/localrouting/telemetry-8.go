...
func watch_LocalRoutes_Static_NextHop_NextHopPath(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedLocalRoutes_Static_NextHop_NextHop_Union) bool) *oc.LocalRoutes_Static_NextHop_NextHop_UnionWatcher {
	...
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		return []genutil.QualifiedValue{convertLocalRoutes_Static_NextHop_NextHopPath(t, md, gs)}, nil
...
func watch_LocalRoutes_Static_NextHop_NextHopPathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedLocalRoutes_Static_NextHop_NextHop_Union) bool) *oc.LocalRoutes_Static_NextHop_NextHop_UnionWatcher {
	t.Helper()
	w := &oc.LocalRoutes_Static_NextHop_NextHop_UnionWatcher{}
	...
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		for _, pre := range sortedPrefixes {
			...
			qv := convertLocalRoutes_Static_NextHop_NextHopPath(t, md, structs[pre])
...
func (n *LocalRoutes_Static_NextHop_NextHopPathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedLocalRoutes_Static_NextHop_NextHop_Union) bool) *oc.LocalRoutes_Static_NextHop_NextHop_UnionWatcher {
	t.Helper()
	return watch_LocalRoutes_Static_NextHop_NextHopPathAny(t, n, timeout, predicate)
}
...
func watch_LocalRoutes_Static_NextHop_RecursePath(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedBool) bool) *oc.BoolWatcher {
	...
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		t.Helper()
		md, _ := genutil.MustUnmarshal(t, upd, oc.GetSchema(), "LocalRoutes_Static_NextHop", gs, queryPath, true, false)
		return []genutil.QualifiedValue{convertLocalRoutes_Static_NextHop_RecursePath(t, md, gs)}, nil
	}, func(qualVal genutil.QualifiedValue) bool {
...
func watch_LocalRoutes_Static_NextHop_RecursePathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedBool) bool) *oc.BoolWatcher {
	t.Helper()
	w := &oc.BoolWatcher{}
	structs := map[string]*oc.LocalRoutes_Static_NextHop{}
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		for _, pre := range sortedPrefixes {
			...
			md, _ := genutil.MustUnmarshal(t, datapointGroups[pre], oc.GetSchema(), "LocalRoutes_Static_NextHop", structs[pre], queryPath, true, false)
			qv := convertLocalRoutes_Static_NextHop_RecursePath(t, md, structs[pre])
			currStructs = append(currStructs, qv)
		}
		return currStructs, nil
	}, func(qualVal genutil.QualifiedValue) bool {
...
func (n *LocalRoutes_Static_NextHop_RecursePathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedBool) bool) *oc.BoolWatcher {
	t.Helper()
	return watch_LocalRoutes_Static_NextHop_RecursePathAny(t, n, timeout, predicate)
}
