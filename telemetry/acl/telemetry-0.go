...
func watch_AclPathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedAcl) bool) *oc.AclWatcher {
	t.Helper()
	w := &oc.AclWatcher{}
	...
	w.W = genutil.MustWatch(t, n, nil, duration, false, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		for _, pre := range sortedPrefixes {
			...
			md, _ := genutil.MustUnmarshal(t, datapointGroups[pre], oc.GetSchema(), "Acl", structs[pre], queryPath, false, false)
			qv := (&oc.QualifiedAcl{
				Metadata: md,
			}).SetVal(structs[pre])
...
func (n *AclPathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedAcl) bool) *oc.AclWatcher {
	t.Helper()
	return watch_AclPathAny(t, n, timeout, predicate)
}
...
func watch_Acl_AclSetPathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedAcl_AclSet) bool) *oc.Acl_AclSetWatcher {
	t.Helper()
	w := &oc.Acl_AclSetWatcher{}
	...
	w.W = genutil.MustWatch(t, n, nil, duration, false, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		for _, pre := range sortedPrefixes {
			...
			md, _ := genutil.MustUnmarshal(t, datapointGroups[pre], oc.GetSchema(), "Acl_AclSet", structs[pre], queryPath, false, false)
			qv := (&oc.QualifiedAcl_AclSet{
				Metadata: md,
			}).SetVal(structs[pre])
			currStructs = append(currStructs, qv)
...
func (n *Acl_AclSetPathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedAcl_AclSet) bool) *oc.Acl_AclSetWatcher {
	t.Helper()
	return watch_Acl_AclSetPathAny(t, n, timeout, predicate)
}
...
func watch_Acl_AclSet_AclEntryPathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedAcl_AclSet_AclEntry) bool) *oc.Acl_AclSet_AclEntryWatcher {
	t.Helper()
	w := &oc.Acl_AclSet_AclEntryWatcher{}
	...
	w.W = genutil.MustWatch(t, n, nil, duration, false, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		for _, pre := range sortedPrefixes {
			...
			md, _ := genutil.MustUnmarshal(t, datapointGroups[pre], oc.GetSchema(), "Acl_AclSet_AclEntry", structs[pre], queryPath, false, false)
			qv := (&oc.QualifiedAcl_AclSet_AclEntry{
				Metadata: md,
			}).SetVal(structs[pre])
			currStructs = append(currStructs, qv)
...
func (n *Acl_AclSet_AclEntryPathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedAcl_AclSet_AclEntry) bool) *oc.Acl_AclSet_AclEntryWatcher {
	t.Helper()
	return watch_Acl_AclSet_AclEntryPathAny(t, n, timeout, predicate)
}
...
func watch_Acl_AclSet_AclEntry_ActionsPathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedAcl_AclSet_AclEntry_Actions) bool) *oc.Acl_AclSet_AclEntry_ActionsWatcher {
	t.Helper()
	w := &oc.Acl_AclSet_AclEntry_ActionsWatcher{}
	structs := map[string]*oc.Acl_AclSet_AclEntry_Actions{}
	w.W = genutil.MustWatch(t, n, nil, duration, false, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		t.Helper()
		datapointGroups, sortedPrefixes := genutil.BundleDatapoints(t, upd, uint(len(queryPath.Elem)))
		var currStructs []genutil.QualifiedValue
		for _, pre := range sortedPrefixes {
			...
			if _, ok := structs[pre]; !ok {
				structs[pre] = &oc.Acl_AclSet_AclEntry_Actions{}
			}
			md, _ := genutil.MustUnmarshal(t, datapointGroups[pre], oc.GetSchema(), "Acl_AclSet_AclEntry_Actions", structs[pre], queryPath, false, false)
			qv := (&oc.QualifiedAcl_AclSet_AclEntry_Actions{
				Metadata: md,
			}).SetVal(structs[pre])
			currStructs = append(currStructs, qv)
...
func (n *Acl_AclSet_AclEntry_ActionsPathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedAcl_AclSet_AclEntry_Actions) bool) *oc.Acl_AclSet_AclEntry_ActionsWatcher {
	t.Helper()
	return watch_Acl_AclSet_AclEntry_ActionsPathAny(t, n, timeout, predicate)
}
...
func watch_Acl_AclSet_AclEntry_Actions_ForwardingActionPath(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedE_Acl_FORWARDING_ACTION) bool) *oc.E_Acl_FORWARDING_ACTIONWatcher {
	...
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		return []genutil.QualifiedValue{convertAcl_AclSet_AclEntry_Actions_ForwardingActionPath(t, md, gs)}, nil
	}, func(qualVal genutil.QualifiedValue) bool {
...
func watch_Acl_AclSet_AclEntry_Actions_ForwardingActionPathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedE_Acl_FORWARDING_ACTION) bool) *oc.E_Acl_FORWARDING_ACTIONWatcher {
	t.Helper()
	w := &oc.E_Acl_FORWARDING_ACTIONWatcher{}
	structs := map[string]*oc.Acl_AclSet_AclEntry_Actions{}
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		for _, pre := range sortedPrefixes {
			...
			md, _ := genutil.MustUnmarshal(t, datapointGroups[pre], oc.GetSchema(), "Acl_AclSet_AclEntry_Actions", structs[pre], queryPath, true, false)
			qv := convertAcl_AclSet_AclEntry_Actions_ForwardingActionPath(t, md, structs[pre])
			currStructs = append(currStructs, qv)
		}
		return currStructs, nil
	}, func(qualVal genutil.QualifiedValue) bool {
...
func (n *Acl_AclSet_AclEntry_Actions_ForwardingActionPathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedE_Acl_FORWARDING_ACTION) bool) *oc.E_Acl_FORWARDING_ACTIONWatcher {
	t.Helper()
	return watch_Acl_AclSet_AclEntry_Actions_ForwardingActionPathAny(t, n, timeout, predicate)
}
...
func watch_Acl_AclSet_AclEntry_Actions_LogActionPath(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedE_Acl_LOG_ACTION) bool) *oc.E_Acl_LOG_ACTIONWatcher {
	...
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		t.Helper()
		md, _ := genutil.MustUnmarshal(t, upd, oc.GetSchema(), "Acl_AclSet_AclEntry_Actions", gs, queryPath, true, false)
		return []genutil.QualifiedValue{convertAcl_AclSet_AclEntry_Actions_LogActionPath(t, md, gs)}, nil
	}, func(qualVal genutil.QualifiedValue) bool {
...
func watch_Acl_AclSet_AclEntry_Actions_LogActionPathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedE_Acl_LOG_ACTION) bool) *oc.E_Acl_LOG_ACTIONWatcher {
	t.Helper()
	w := &oc.E_Acl_LOG_ACTIONWatcher{}
	structs := map[string]*oc.Acl_AclSet_AclEntry_Actions{}
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		for _, pre := range sortedPrefixes {
			...
			md, _ := genutil.MustUnmarshal(t, datapointGroups[pre], oc.GetSchema(), "Acl_AclSet_AclEntry_Actions", structs[pre], queryPath, true, false)
			qv := convertAcl_AclSet_AclEntry_Actions_LogActionPath(t, md, structs[pre])
			currStructs = append(currStructs, qv)
		}
		return currStructs, nil
	}, func(qualVal genutil.QualifiedValue) bool {
...
func (n *Acl_AclSet_AclEntry_Actions_LogActionPathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedE_Acl_LOG_ACTION) bool) *oc.E_Acl_LOG_ACTIONWatcher {
	t.Helper()
	return watch_Acl_AclSet_AclEntry_Actions_LogActionPathAny(t, n, timeout, predicate)
}
...
func watch_Acl_AclSet_AclEntry_DescriptionPath(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedString) bool) *oc.StringWatcher {
	...
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		return []genutil.QualifiedValue{convertAcl_AclSet_AclEntry_DescriptionPath(t, md, gs)}, nil
	}, func(qualVal genutil.QualifiedValue) bool {
...
func watch_Acl_AclSet_AclEntry_DescriptionPathAny(t testing.TB, n ygot.PathStruct, duration time.Duration, predicate func(val *oc.QualifiedString) bool) *oc.StringWatcher {
	t.Helper()
	w := &oc.StringWatcher{}
	structs := map[string]*oc.Acl_AclSet_AclEntry{}
	w.W = genutil.MustWatch(t, n, nil, duration, true, func(upd []*genutil.DataPoint, queryPath *gpb.Path) ([]genutil.QualifiedValue, error) {
		...
		for _, pre := range sortedPrefixes {
			...
			qv := convertAcl_AclSet_AclEntry_DescriptionPath(t, md, structs[pre])
			currStructs = append(currStructs, qv)
		}
		return currStructs, nil
	}, func(qualVal genutil.QualifiedValue) bool {
...
func (n *Acl_AclSet_AclEntry_DescriptionPathAny) Watch(t testing.TB, timeout time.Duration, predicate func(val *oc.QualifiedString) bool) *oc.StringWatcher {
	t.Helper()
	return watch_Acl_AclSet_AclEntry_DescriptionPathAny(t, n, timeout, predicate)
}
