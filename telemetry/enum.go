...
func (E_BgpPolicy_BgpNextHopType_Enum) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }
...
func (E_TransportTypes_AdminStateType) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum }
