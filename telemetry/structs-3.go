...
// struct.
func (t *NetworkInstance_Protocol_Bgp_Neighbor) SetPeerType(v E_BgpTypes_PeerType) {
	t.PeerType = v
}

// SetRemovePrivateAs sets the value of the leaf RemovePrivateAs in the NetworkInstance_Protocol_Bgp_Neighbor
// struct.
func (t *NetworkInstance_Protocol_Bgp_Neighbor) SetRemovePrivateAs(v E_BgpTypes_RemovePrivateAsOption) {
	t.RemovePrivateAs = v
}
...
// struct.
func (t *NetworkInstance_Protocol_Bgp_Neighbor) SetSendCommunity(v E_BgpTypes_CommunityType) {
	t.SendCommunity = v
}
