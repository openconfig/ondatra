...
// Device struct. The keys of the list are populated from the input
// arguments.
func (t *Device) NewLldpInterface(Name string) (*LldpInterface, error) {
...
// the Device struct. The entry with key oldK is renamed to newK updating
// the key within the value.
func (t *Device) RenameLldpInterface(oldK, newK string) error {
...
// the receiver Device. If the entry does not exist, then it is created.
// It returns the existing or new list member.
func (t *Device) GetOrCreateLldpInterface(Name string) *LldpInterface {
...
// the LldpInterface map field of Device. If the receiver is nil, or
// the specified key is not present in the list, nil is returned such that Get*
// methods may be safely chained.
func (t *Device) GetLldpInterface(Name string) *LldpInterface {
...
// the receiver Device. If there is no such element, the function
// is a no-op.
func (t *Device) DeleteLldpInterface(Name string) {
	key := Name
...
// list LldpInterface of Device. If the key value(s) specified in
// the supplied LldpInterface already exist in the list, an error is
// returned.
func (t *Device) AppendLldpInterface(v *LldpInterface) error {
	if v.Name == nil {
		return fmt.Errorf("invalid nil key received for Name")
	}
