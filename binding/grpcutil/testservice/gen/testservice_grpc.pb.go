...
func (c *testClient) SendUnary(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	...
	err := c.cc.Invoke(ctx, Test_SendUnary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testClient) SendStream(ctx context.Context, opts ...grpc.CallOption) (Test_SendStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Test_ServiceDesc.Streams[0], Test_SendStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
