...
// System_GrpcServer_CaTrustBundleIdPath represents the /openconfig-system/system/grpc-servers/grpc-server/config/ca-trust-bundle-id YANG schema element.
type System_GrpcServer_CaTrustBundleIdPath struct {
	*ygot.NodePath
}

// System_GrpcServer_CaTrustBundleIdPathAny represents the wildcard version of the /openconfig-system/system/grpc-servers/grpc-server/config/ca-trust-bundle-id YANG schema element.
...
// System_GrpcServer_CertificateRevocationListBundleIdPath represents the /openconfig-system/system/grpc-servers/grpc-server/config/certificate-revocation-list-bundle-id YANG schema element.
type System_GrpcServer_CertificateRevocationListBundleIdPath struct {
	*ygot.NodePath
}

// System_GrpcServer_CertificateRevocationListBundleIdPathAny represents the wildcard version of the /openconfig-system/system/grpc-servers/grpc-server/config/certificate-revocation-list-bundle-id YANG schema element.
...
// System_GrpcServer_GnmiPathzPolicyIdPath represents the /openconfig-system/system/grpc-servers/grpc-server/config/gnmi-pathz-policy-id YANG schema element.
type System_GrpcServer_GnmiPathzPolicyIdPath struct {
	*ygot.NodePath
}

// System_GrpcServer_GnmiPathzPolicyIdPathAny represents the wildcard version of the /openconfig-system/system/grpc-servers/grpc-server/config/gnmi-pathz-policy-id YANG schema element.
