...
const (
	HTTPOverGRPC_HTTPRequest_FullMethodName = "/httpovergrpc.HTTPOverGRPC/HTTPRequest"
)
...
func (c *hTTPOverGRPCClient) HTTPRequest(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	...
	out := new(Response)
	err := c.cc.Invoke(ctx, HTTPOverGRPC_HTTPRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedHTTPOverGRPCServer must be embedded to have
...
func (UnimplementedHTTPOverGRPCServer) testEmbeddedByValue()                      {}
...
func RegisterHTTPOverGRPCServer(s grpc.ServiceRegistrar, srv HTTPOverGRPCServer) {
	// If the following call pancis, it indicates UnimplementedHTTPOverGRPCServer was
...
func _HTTPOverGRPC_HTTPRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HTTPOverGRPC_HTTPRequest_FullMethodName,
	}
